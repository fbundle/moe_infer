...
def run(model_path_str, output_dir_str=None, layers_str=None):
    ...
    output_dir = Path(output_dir_str) if output_dir_str else Path("data/packed_experts")
...
def main():
    ...
    run(args.model, args.output, args.layers)
