...
#define MODEL_PATH_DEFAULT "/Volumes/Hippopotamus/vault/code/flash-moe/data/models--mlx-community--Qwen3.5-35B-A3B-4bit"
...
// ============================================================================
// #define TOKENIZER_IMPL  // disabled — hardcoded prompt IDs
// tokenizer.h not needed — hardcoded prompt IDs

static void *g_tokenizer_unused;  // tokenizer disabled
static int g_tokenizer_loaded = 0;  // always 0
...
static PromptTokens *encode_prompt_text_to_tokens(const char *text) {
    ...
    (void)text;
    static const uint32_t hardcoded[] = {248045, 8678, 198, 2523, 513, 264, 10631, 17313, 13, 593, 26003, 248046, 198, 248045, 846, 198, 9419, 11, 1204, 513, 488, 30, 248046, 198, 248045, 74455, 198, 248068, 198};
    int n = 29;
