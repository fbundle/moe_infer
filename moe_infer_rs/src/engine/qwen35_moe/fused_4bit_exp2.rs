...
struct ExecCtx<'b, 'a, C: ModelConfig> {
    engine: &'b mut Fused4bitExp2<'a, C>,
...
pub struct Fused4bitExp2<'a, C: ModelConfig> {
    pub model: &'a Model,
...
impl<'a, C: ModelConfig> Fused4bitExp2<'a, C> {
    pub fn new(
        model: &'a Model,
        ctx: &'a MetalContext,
...
impl<'a, C: ModelConfig> Engine for Fused4bitExp2<'a, C> {
