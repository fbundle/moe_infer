...
\texttt{moe_infer/helpers/verify\_vs\_original.py}).
...
\texttt{moe_infer/helpers/analyze\_expert\_lowrank.py}). Findings:
\begin{itemize}
...
I/O, and CPU routing (script: \texttt{moe_infer/helpers/bench\_io.py}). On M4,
