/// Qwen3.6-35B-A3B-BQ4 FusedBq4Exp2 engine.
///
...
pub struct FusedBq4Exp2<C: ModelConfig> {
    pub model: Arc<Model>,
...
impl<C: ModelConfig> FusedBq4Exp2<C> {
...
impl<C: ModelConfig> Engine for FusedBq4Exp2<C> {
